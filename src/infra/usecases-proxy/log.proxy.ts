...
class LogProxy {
  ...
  insertLog() {
    const insertLogUseCase = new InsertLogUseCase(
      repositories.log,
      repositories.project,
      // repositories.sender as any,
    ); //Any server para testar sem subir o whatsapp
  ...
  getLogByProject() {
    const getLogByProjectUseCase = new GetLogByProjectUseCase(
      repositories.log,
      repositories.project,
    );
    const getLogByProjectController = new GetLogByProjectController(
      getLogByProjectUseCase,
    );
